...
void entry::make_typed_float_vector(vector<char> &out, const string &in, int number )
{
	...
	unsigned char end[4] = {0x02, 0x00, 0x80, 0x7F};
...
{
	static unsigned char end_float[4] = {0x02, 0x00, 0x80, 0x7F};
	static unsigned char end_int1 = 0x81;
	static unsigned char end_int2[2] = {0x01, 0x80};
	static unsigned char end_int3[4] = {0x01, 0x00, 0x00, 0x80};
